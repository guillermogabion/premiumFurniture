...
//   // Set the logo image based on the background color
//   if (logoHeader !== "white") {
//     var organizationImageUrl = "{{ $organization ? asset('orgImage/' . $organization->orgImage) : 'https://via.placeholder.com/100/CCCCCC/FFFFFF' }}";
    
//     // Set the logo src and other attributes
//     $(".logo-header .navbar-brand").attr({
//       "src": organizationImageUrl,
//       "alt": "Image Preview",
//       "style": "display: block; width: auto; height: 50px; border-radius: 50%; object-fit: cover; border: 1px solid #ddd; padding: 5px; cursor: pointer;"
//     });
//   } else {
//     // Use a variable to hold the image URL from the backend
//     var organizationImageUrl = "{{ $organization ? asset('orgImage/' . $organization->orgImage) : 'https://via.placeholder.com/100/CCCCCC/FFFFFF' }}";
